  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        {/* Featured Products Section (Main Landing) */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {CATEGORIES.map((cat) => (
                ...
                >
                  <div className="relative w-full aspect-[16/9] rounded-[2rem] overflow-hidden bg-white border border-border/50 hover:border-primary/30 hover:shadow-xl transition-all mb-4">
                    <Image 
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                       <span className="text-white text-2xl font-black uppercase tracking-widest drop-shadow-lg">{cat.name}</span>
                    </div>
                  </div>
                </Link>
              ))}
